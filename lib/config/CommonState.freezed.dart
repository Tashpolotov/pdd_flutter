...
abstract class $CommonStateCopyWith<T, $Res> {
  factory $CommonStateCopyWith(
    CommonState<T> value,
    $Res Function(CommonState<T>) then,
...
class __$$InitialImplCopyWithImpl<T, $Res>
    extends _$CommonStateCopyWithImpl<T, $Res, _$InitialImpl<T>>
...
abstract class Initial<T> implements CommonState<T> {
...
abstract class Loading<T> implements CommonState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$CommonStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'CommonState<$T>.error(message: $message)';
  }
...
abstract class Error<T> implements CommonState<T> {
